<template>
  <div class="background">
    <el-card class="card" :body-style="{ padding: '0px' }">
      ...
      >
      <el-divider />
      <el-button text class="button" @click="exit()"
        ><el-icon size="large"><Right /></el-icon
        ><span>退出登陆</span></el-button
      >
      <el-divider />
    </el-card>
  </div>
